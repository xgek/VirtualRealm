...
#[derive(Debug)]
pub struct VirtualRealmProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VirtualRealmProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VirtualRealm processing");
    
    let mut processor = VirtualRealmProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VirtualRealmProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VirtualRealmProcessor::new(false);
